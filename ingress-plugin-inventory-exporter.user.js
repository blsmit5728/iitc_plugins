// ==UserScript==
// @author         ABeerSlayer with contribution 633KYN35D with significant code from EisFrei
// @id             inventoryParser@abeerslayer
// @name           IITC Plugin: Inventory Copy
// @category       Info
// @version        0.0.1
// @namespace      https://github.com/633KYN35D/iitc-inventory-parser
// @downloadURL    https://github.com/blsmit5728/iitc_plugins/raw/main/ingress-plugin-inventory-exporter.user.js
// @homepageURL    https://github.com/blsmit5728/iitc_plugins
// @description    Parse Inventory from Ingress
// @updateURL      https://github.com/blsmit5728/iitc_plugins/raw/main/ingress-plugin-inventory-exporter.user.js
...
<button type="button" class="ui-button"  onclick="window.plugin.inventoryParser.copyGearToClipboard()">Copy Gear Inventory</button>`
    }
    ...
    thisPlugin.copyGearToClipboard = function () {
        var dataArray = [];
        $.each(thisPlugin.itemCount, function (idx, item) {
            var itemLine = {}
            itemLine.resourceType = item.resourceType;
        ...
        console.log("[COPYINV]");
        thisPlugin.copyCSV(dataArray);
    };

    thisPlugin.copyCSV = function (dataArray) {
        var csvArray = [];
        var csvCols = [];
